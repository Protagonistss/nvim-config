...
-- 获取特定图标
function M.get_icon(icon_name, category)
  category = category or "ui"
  if M.icons[category] and M.icons[category][icon_name] then
    return M.icons[category][icon_name]
  end
  -- 如果找不到，返回默认值
  return M.icons.ui.file or "*"
end
